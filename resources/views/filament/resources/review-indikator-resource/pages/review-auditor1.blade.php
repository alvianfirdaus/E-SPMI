...
<x-filament-panels::page>
    <div class="space-y-6">
        ...
        @if (count($conflicts) > 0)
            <div
                class="fi-section-content-ctn bg-danger-50 dark:bg-danger-950 border border-danger-200 dark:border-danger-800 rounded-xl p-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    @if ($assignment->assignAuditors->auditor1Relation)
                        <div class="flex items-center gap-3">
                            <div
                                class="w-8 h-8 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center">
                                <span class="text-xs font-medium text-primary-600 dark:text-primary-300">A1</span>
                            </div>
                            <div>
                                <p class="text-sm font-medium text-info-900 dark:text-info-100">
                                    {{ $assignment->assignAuditors->auditor1Relation->name }}
                                </p>
                                <p class="text-xs text-primary-600 dark:text-primary-400">Auditor 1</p>
                            </div>
                        </div>
                    @endif
                    ...
                    @if ($assignment->assignAuditors->auditor2Relation)
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-info-600 dark:text-info-400">Auditor 2 (Anda)</p>
                            </div>
                        </div>
                    @endif
                </div>
        ...
        <div
            ...
            <div class="border-b border-gray-200 dark:border-gray-700">
                <nav class="-mb-px flex px-6 gap-3" aria-label="Tabs">
