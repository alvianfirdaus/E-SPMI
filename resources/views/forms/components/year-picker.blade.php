<x-dynamic-component :component="$getFieldWrapperView()" :field="$field">
    <div x-data="{
        ...
        <x-filament::input.wrapper     prefix-icon="heroicon-o-calendar">
            ...
            <x-filament::input type="text" x-model="state" placeholder="yyyy" readonly @click="isOpen = !isOpen" />
        ...
        <x-filament::section x-show="isOpen" @click.outside="isOpen = false"
            ...
            class="absolute top-full left-0 border border-gray-300 rounded shadow-lg z-10 mt-1 w-full max-w-xs">
            ...
            <div class="flex flex-wrap gap-4 p-2 w-full justify-between">
